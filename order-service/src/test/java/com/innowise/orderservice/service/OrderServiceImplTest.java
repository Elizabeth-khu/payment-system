...
class OrderServiceImplTest {
    ...
    void getOrderById_Success() {
        ...
        when(userServiceClient.getUserById(mockOrder.getUserId())).thenReturn(mockUser);
        ...
        verify(userServiceClient, times(1)).getUserById(anyString());
    }
    ...
    void createOrder_Success() {
        OrderCreateRequest request = new OrderCreateRequest("user-123", "idemp-key-123", List.of(new OrderItemRequest("item-1", 2)));
